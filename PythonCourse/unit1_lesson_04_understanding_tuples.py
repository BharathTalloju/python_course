...
def test_sequence_conversion():
    ...
    list_2 = list(tup_1)
    assert list_2 == list(tup_1) == list_2
...
def min_max(input):
    ...
    """
    return (sorted(input)[0],sorted(input)[len(input) - 1])  # write a line of code to return containing min and max
...
-   pre-defined functions of tuples
-   inter changing of different sequence types
-   a tuple consistiong of no elements is a tuple but a tuple with one element is not a tuple
"""
