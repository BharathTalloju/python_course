...
-   In control flow statements, empty strings, tuples, lists, dicts, sets and object None are assigned false
    and non-empty sequences are assigned true.
-   0 and 1 are assigned true and false boolean values respectively.
-
"""
